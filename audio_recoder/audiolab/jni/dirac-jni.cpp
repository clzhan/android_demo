...
extern "C" JNIEXPORT jdouble JNICALL Java_io_hpp_audiolab_Dirac_getFrequencyAnalysis(
		JNIEnv *env
		//jobject thiz,
		){
...
extern "C" JNIEXPORT void JNICALL Java_io_hpp_audiolab_Dirac_init(
		JNIEnv *env,
		//jobject thiz,
		jobject g_audioBufferFillCB){
